...
?>
<? if ($arResult['SECTIONS_COUNT'] > 0): ?> <div class="col-lg-8 col-md-7"><? elseif ($arResult['SECTION']['DETAIL_PICTURE']): ?><div class="col-lg-3 col-md-5"><? endif ?>
        <div class="catalog-section-list page-content tab-content" id="pills-tabContent">
            ...
            <? if ($detailPicture['WIDTH'] > 800): ?>
                <a title="<?= $arResult['SECTION']["NAME"] ?> <?= $arResult['SECTION']['UF_TABNAME'] ?>" href="<?= $detailPicture['SRC'] ?>" data-fancybox>
                <? endif; ?>
                <img src="<?= $detailPicture['SRC']; ?>" alt="<?= $arResult['SECTION']["NAME"] ?> <?= $arResult['SECTION']['UF_TABNAME'] ?>">
                <? if ($detailPicture['WIDTH'] > 800): ?></a><? endif; ?>
        <? endif; */ ?>
                <? if ($arResult['SECTION']['DESCRIPTION']): ?>
                    <div class="decription lh-sm<?= $arResult['SECTION']['DETAIL_PICTURE'] ? ' mt-2' : '' ?>">
