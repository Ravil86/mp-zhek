		...
		<form name="form_auth" method="post" target="_top" action="<?= $arResult["AUTH_URL"] ?>">
			...
			<table class="bx-auth-table">
				<tr>
					...
					<td><input class="bx-auth-input form-control" type="text" name="USER_OTP" maxlength="50" value="" autocomplete="off" /></td>
				</tr>
				...
				<tr>
					<td></td>
					<td class="authorize-submit-cell"><input type="submit" class="btn btn-primary" name="Otp" value="<?= GetMessage("AUTH_OTP_AUTHORIZE") ?>" /></td>
				</tr>
			</table>
