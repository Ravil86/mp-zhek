...
<html lang="en">
    ...
    <body>
        <!-- // TopBar start -->
       <? $APPLICATION->IncludeFile("include/top_bar.php", Array(), Array("MODE" => "html"));?>
        <!--// TopBar end -->
        <!-- Navigation-->
        <nav class="navbar sticky-top navbar-expand-lg bg-white bg-body-tertiary!">
            <div class="container">
                <a class="navbar-brand d-flex align-items-center" href="#">
                    <img src="<?=SITE_TEMPLATE_PATH?>/img/logo.svg"/>
                    <div class="h4 ps-2 navbar-text">Муниципальное предприятие «ЖЭК-3»
						<div class="logo-text">Ханты-Мансийского района</div>
                    </div>
                </a>
