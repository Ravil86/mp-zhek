...
// const tooltipTitleDefault = "Скопировать текст";
...
$(document).ready(function () {
  ...
  $(".collapsible-mobile-submenus .navbar-submenu > a").on(
    "click",
    function (event) {
      // $(".collapsible-mobile-submenus .template-arrow-menu").on("click", function(event){

      // $(this).closest('.mobile-menu').find('ul.submenu:visible').slideUp(300)
      // $(this).closest('.mobile-menu').find('ul.submenu:visible').each(function(i, obj) {
      // 	// obj.slideUp()
      // 	console.log(obj);
      // });
      ...
      // console.log(i);
      // });
      // if( $(this).closest('.mobile-menu').find('.submenu').is(":visible") )
      // 	$(this).closest('.mobile-menu').find('.submenu').slideUp()
  ...
  if ($(".tabs").length > 0) {
    $(".tabs:not('.no-scroll')").on("tabsbeforeactivate", function (event, ui) {
      $("html, body").animate(
        {
          scrollTop: $("#" + $(ui.newTab).children("a").attr("id")).offset()
            .top,
        },
        400,
      );
