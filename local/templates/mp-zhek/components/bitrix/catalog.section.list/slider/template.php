			...
			?>
				<div id="<? echo $this->GetEditAreaId($arSection['ID']); ?>" class="service-list-item">
					<div class="service-list-tile-img-container">
						<a href="<? echo $arSection['SECTION_PAGE_URL']; ?>" class="service-list-item-img" style="background-image:url('<? echo $arSection['PICTURE']['SRC']; ?>');" title="<? echo $arSection['PICTURE']['TITLE']; ?>"></a>
					</div>
