...
$arViewStyles = array(
	'LIST' => array(
		'CONT' => 'main_list list! margin-top-20',
		'TITLE' => 'main_list_title',
		'LIST' => 'main_list_ul',
	),
	'LINE' => array(
	...
	switch ($arParams['VIEW_MODE'])
	{
		...
		case 'LIST':
			...
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				?><li class="mb-2 template-tick-1" id="<?=$this->GetEditAreaId($arSection['ID']);?>"><h2 class="main_list_li_title"><a href="<? echo $arSection["SECTION_PAGE_URL"]; ?>"><? echo $arSection["NAME"];?><?
				if ($arParams["COUNT_ELEMENTS"] && $arSection['ELEMENT_CNT'] !== null)
				{
					?> <span>(<? echo $arSection["ELEMENT_CNT"]; ?>)</span><?
				}
