            ...
            foreach($arResult as $arItem):?>
                ...
                <?if ($arItem["IS_PARENT"]):?>
                    ...
                    <?if ($arItem["DEPTH_LEVEL"] == 1):?>
                        ...
                        <?//endif?>
                    <?else:?>
                        <li class="dropdown-item<?if ($arItem["SELECTED"]):?> active selected<?endif?>">
                                <a class="dropdown-link" href="<?=$arItem["LINK"]?>"><?=$arItem["TEXT"]?></a>
                            <ul>
                    <?endif?>
                ...
                <?else:?>
                    ...
                    <?if ($arItem["PERMISSION"] > "D"):?>
                        ...
                        <?else:?>
                            <li class="dropdown-item<?if ($arItem["SELECTED"]):?> active selected<?endif?>">
                                <a class="dropdown-link" href="<?=$arItem["LINK"]?>"<?=$arItem["PARAMS"]['TARGET']?' target="'.$arItem["PARAMS"]['TARGET'].'"':''?>>
                                <?=$arItem["TEXT"]?>
                            </a></li>
                        <?endif?>
                    ...
                    <?else:?>
                        ...
                        <?else:?>
                            <li class="nav-item dropdown-item<?if ($arItem["SELECTED"]):?> active selected<?endif?>"><a href="nav-link" class="denied" title="<?=GetMessage("MENU_ITEM_ACCESS_DENIED")?>"><?=$arItem["TEXT"]?></a></li>
                        <?endif?>
