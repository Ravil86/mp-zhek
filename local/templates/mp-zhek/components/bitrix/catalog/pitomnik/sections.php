...
// dump($arResult);
?>
<div class="row full-width gray padding-top-40 padding-bottom-30">
	<div class="row">
		<h2 class="box-header">Приют "Собачье сердце"</h2>
		<p class="description align-center mt-2">Хотите взять собаку! Каталог </p>
	</div>
</div>
<div class="container">
	<div class="row">
	...
	if ($arParams["SHOW_TOP_ELEMENTS"] !== "N")
	{
		...
		/*$APPLICATION->IncludeComponent("bitrix:catalog.top", "card", array(
				"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
				"IBLOCK_ID" => $arParams["IBLOCK_ID"],
		...
		$APPLICATION->IncludeComponent("bitrix:catalog.section", "cards", array(
			"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
			"IBLOCK_ID" => $arParams["IBLOCK_ID"],
